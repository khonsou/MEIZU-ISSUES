...
RedmineApp::Application.routes.draw do
  ...
  match 'issues/tagging/:issue_id', :to => 'taggings#issue', :as => 'tagging_issue', :via => [:put, :post]
  ...
  resources :projects do
    ...
    resources :wiki, :except => [:index, :create] do
      member do
        get 'rename'
        post 'rename'
        get 'history'
  ...
  get 'activity/latest', to: 'activities#latest', as: :latest_activity
